                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="birth_date" type="date"
                                        ...
                                        value="{{ old('birth_date') }}" required autocomplete="bday">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="address" type="text"
                                        ...
                                        value="{{ old('address') }}" required autocomplete="address-line1">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="contact" type="number"
                                        ...
                                        value="{{ old('contact') }}" required autocomplete="tel">
                            ...
                            <div class="row mb-3">
                                <label for="paypal_id"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Paypal ID') }}</label>

                                <div class="col-md-6">
                                    <input id="paypal_id" type="text"
                                        class="form-control @error('paypal_id') is-invalid @enderror" name="paypal_id"
                                        value="{{ old('paypal_id') }}" required autocomplete="paypal_id">
